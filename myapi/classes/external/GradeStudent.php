...
class GradeStudent extends external_api
{
     ...
     public static function get_student_grades($courseid)
     {
          ...
          // SQL query to get all students' grades with grade category names in a given course
          ...
          $grades = $DB->get_records_sql($sql, ['courseid' => 2]);

          // Format the result as expected by the return structure.
          $result = [];
     ...
     public static function get_student_grades_returns()
     {
          return new external_multiple_structure(
               new external_single_structure([
                    ...
                    'grade_item' => new external_value(PARAM_TEXT, 'Name of the grade item'),
                    'category_name' => new external_value(PARAM_TEXT, 'Name of the grade category'),
